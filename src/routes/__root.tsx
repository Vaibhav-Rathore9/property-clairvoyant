...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pricepoint — AI Rental Pricing Copilot" },
      { name: "twitter:title", content: "Pricepoint — AI Rental Pricing Copilot" },
      { property: "og:description", content: "Explainable, context-aware rental pricing recommendations for analysts." },
      { name: "twitter:description", content: "Explainable, context-aware rental pricing recommendations for analysts." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/e6b54c75-e4f8-4d4d-9b36-9d868a1ea163" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/e6b54c75-e4f8-4d4d-9b36-9d868a1ea163" },
